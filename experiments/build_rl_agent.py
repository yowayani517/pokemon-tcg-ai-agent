...
DECK = [int(x) for x in open(os.path.join(HERE, "gauntlet_top", "03_mm-1989.csv")) if x.strip()]
...
out = TEMPLATE.format(deck=DECK, attackers={717: 3, 934: 3}, fk=FK, arrays=json.dumps(arrays))
path = os.path.join(ROOT, "agent", "main_rl.py")
